...
const QUESTION_TYPES = [
  ...
  { code: 'grammar_choice', category: 'grammar', name: '语法单项选择', description: '从选项中选择正确的语法答案。', supportedItemTypes: ['grammar'], implementationStatus: 'available', defaultWeight: 20, instructionText: '选择正确的语法答案。', primaryActionText: '提交答案', hintText: '', displayOptions: { showExample: true } },
  { code: 'grammar_completion', category: 'grammar', name: '语法完成句子', description: '根据题干要求填写完整句子或缺失部分。', supportedItemTypes: ['grammar'], implementationStatus: 'available', defaultWeight: 20, instructionText: '根据要求完成句子。', primaryActionText: '提交答案', hintText: '', displayOptions: { showExample: true } },
  ...
  { code: 'grammar_sentence_transform', category: 'grammar', name: '语法句型转换', description: '按要求改写句子，考查语法结构。', supportedItemTypes: ['grammar'], implementationStatus: 'available', defaultWeight: 10, instructionText: '按要求改写句子。', primaryActionText: '提交答案', hintText: '', displayOptions: { showExample: true } },

...
const QUESTION_TYPES = [
  ...
  { code: 'grammar_choice', category: 'grammar', name: '??????', description: '???????????????', supportedItemTypes: ['grammar'], implementationStatus: 'available', defaultWeight: 20, instructionText: '?????????????', primaryActionText: '????', hintText: '', displayOptions: { showExample: true } },
  { code: 'grammar_completion', category: 'grammar', name: '??????', description: '??????????????????', supportedItemTypes: ['grammar'], implementationStatus: 'available', defaultWeight: 20, instructionText: '???????????', primaryActionText: '????', hintText: '', displayOptions: { showExample: true } },
  ...
  { code: 'grammar_sentence_transform', category: 'grammar', name: '??????', description: '???????????????', supportedItemTypes: ['grammar'], implementationStatus: 'available', defaultWeight: 10, instructionText: '??????????', primaryActionText: '????', hintText: '', displayOptions: { showExample: true } },

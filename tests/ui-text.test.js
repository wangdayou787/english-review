...
const expectedText = {
  ...
  'views/practice/exercise.ejs': ['提交答案', '播放发音', '输入你的答案', '单词拼写填空', '词形变换填空', '短语单选辨析', '连词成句增强版', '首字母提示', '目标词形', '英译中填空', '语法单项选择', '语法完成句子', '语法句型转换'],
  ...
  'views/admin/item-edit.ejs': ['编辑条目', '题型扩展信息', '辨析题', '连词成句兼容设置', '首字母提示', '提示文案', '保存', '取消', '语法知识结构', '语法说明', '使用规则', '例题解析', '句型转换'],
  'views/admin/review-plan.ejs': ['复习计划', '当前启用计划', '启用此复习计划', '每日配额'],
  'data/question-types.js': ['单词词汇类', '短语固定搭配类', '语法专项类', '句子句型类', '完形填空类', '阅读理解类', '互译填空'],
